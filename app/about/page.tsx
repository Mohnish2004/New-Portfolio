    ...
    <section data-aos="fade-in" className="antialiased max-w-xl p-4 mx-4 sm:mx-auto">
      ...
      <div className="prose mx-auto">
        ...
        <div className="relative h-64 my-8 flex justify-center items-center group">
          <div className="absolute transition-all duration-300 transform cursor-pointer group-hover:translate-x-[-40px] group-hover:rotate-[-16deg] left-[20%] top-1/2 -translate-y-1/2">
            <Image
              src="/exp_pics/H.png"
              alt="Polaroid 1"
              width={100}
          ...
          <div className="absolute transition-all duration-300 transform cursor-pointer group-hover:translate-x-[-20px] group-hover:rotate-[-8deg] left-[30%] top-1/2 -translate-y-1/2">
            <Image
              src="/exp_pics/a.JPG"
              alt="Polaroid 2"
              width={100}
          ...
          <div className="absolute transition-all duration-300 transform cursor-pointer group-hover:translate-x-[20px] group-hover:rotate-[8deg] left-[50%] top-1/2 -translate-y-1/2">
            <Image
              src="/exp_pics/a9.jpg"
              alt="Polaroid 4"
              width={100}
          ...
          <div className="absolute transition-all duration-300 transform cursor-pointer group-hover:translate-x-[40px] group-hover:rotate-[16deg] left-[60%] top-1/2 -translate-y-1/2">
            <Image
              src="/exp_pics/d.JPG"
              alt="Polaroid 5"
              width={100}
        ...
        <p data-aos="fade-in" className="text-neutral-600 dark:text-neutral-300 font-semibold mb-2">
          Regards
        </p>
