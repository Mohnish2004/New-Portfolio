...
// Extract project card component
...
const ProjectCard = ({ title, description, imageSrc, readMoreUrl, viewSiteUrl, imageAlt = "Project preview" }: ProjectCardProps) => (
  <div className="mb-5">
    <div data-aos="fade-up" className="rounded-lg border border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-800 transition-all duration-300 hover:scale-105 hover:shadow-xl">
      <div className="flex flex-col md:flex-row">
        <div className="p-6 md:w-1/2 flex flex-col justify-between">
          <div>
            ...
            <div className="mt-4">
              ...
              {viewSiteUrl && (
                <button
                  onClick={() => window.location.href = viewSiteUrl}
                  type="button"
        ...
        <div className="md:w-1/2">
          <a className="group block h-full" href={readMoreUrl || "#"}>
...
const TestimonialCard = ({
  ...
  const tooltipPlacement = isLeft ? "left-start" : "right-start";
  const containerClasses = cn(
    "flex items-start mb-5 mt-5 gap-2.5",
    !isLeft && "justify-end"
  );
    ...
    <Tooltip
      ...
      content={
        <div className="px-1 py-2">
          <div className="text-small font-bold">{company}</div>
          <div className="text-tiny">{role}</div>
        </div>
      }
    >
      <Image 
      ...
      <div className="flex flex-col gap-1 w-full max-w-[320px]">
        ...
        <div className="flex flex-col leading-1.5 p-4 border-gray-200 rounded-tl-lg rounded-b-lg bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-800 rounded-es-xl">
          <p className="text-sm text-gray-900 dark:text-white">
            {isExpanded ? message : truncatedContent}
...
const Home = () => {
  const words = ["Developer", "Manager", "Designer", "Researcher","Leader","Photographer","Innovator", "Tourguide", "Full-stack","Mobile/Web","AI/ML","Security","Product","PM"];
  const duration = 2000;
  ...
  return (
    <section className="antialiased max-w-xl mx-4 mt-8 sm:mx-auto">
      <Dot delay={0.25} inView>
        <div className="relative mb-4 left-[-46px]">
          <Image 
            src="/1.svg" 
            alt="Profile" 
            width={250} 
      ...
      <div data-aos="fade-in" data-aos-delay="900">
        <p data-aos="fade-in">
          I&apos;m a third-year Computer Science student at the University of California, Davis. With a passion for solving problems one {" "}
          <LinkPreview
            url="/projects"
          ...
          {""} at a time. Starting from my dorm room projects, I&apos;ve cultivated a versatile skill set through diverse client engagements and hands-on{" "}
          <LinkPreview
        ...
        <p data-aos="fade-in" className="mt-4">
          My journey in tech started small but quickly grew as I embraced many roles including leadership. Currently, I serve as the president of {" "}
          <LinkPreview
      ...
      <h2 data-aos="fade-in" className="font-medium mb-5 mt-4 text-2xl">
        Featured work
      </h2>

      <ProjectCard
        title="D2D Cure"
        description="A comprehensive overhaul of the D2D Cure Database, improving user experience and enzyme data management. Supporting biotech research for the next decade."
        imageSrc="/projects/cure.png"
        readMoreUrl="https://medium.com/@mohnish.gopi/d2dcure-5b41fcbc0ee4"
        viewSiteUrl="https://d2d-cure.vercel.app/"
      />

      <ProjectCard
        title="Rosetta Commons Education Hub"
        description="An educational platform built for Rosetta Commons offering curated resources for mastering Rosetta and ML-based tools in biomolecular modeling and design."
        imageSrc="/projects/eduhub.png"
        viewSiteUrl="https://test-wine-seven-64.vercel.app/"
      />

      <ProjectCard
        title="Slate"
        description="A crowd-sourced AI note-taking platform powered by Gemini, serving as a dynamic hub for studying, instructor-endorsed answers, and collaboration."
        imageSrc="/projects/slate.jpg"
        readMoreUrl="https://devpost.com/software/slate-pas0bz"
      />

      <ProjectCard
        title="Enzyme Rate Calculator"
        description="A web appl developed to streamline the calculation of enzyme reaction rates and generate graphs from student-generated data for the Design 2 Data (D2D) project"
        imageSrc="/projects/d2d2.png"
        readMoreUrl="https://medium.com/@mohnish.gopi/d2d-enzyme-rate-calculator-c1cc87f268f4"
      />
      ...
      <TestimonialCard
        name="Geetika"
        message={sentence}
        imageSrc="https://media.licdn.com/dms/image/D4D03AQGGI9xxCnbrJg/profile-displayphoto-shrink_200_200/0/1679623474258?e=2147483647&v=beta&t=VFlTvlVnkq8xnOO9GhLVAp6KneyqroowGcBVumDuYK4"
        company="Amazon"
      ...
      <TestimonialCard
        name="Kamal"
        message={sentence2}
        imageSrc="/Testimonial/kamal.jpeg"
        company="Maximo Esolutions"
        role="Business Consultant"
        isExpanded={isExpanded2}
        toggleExpand={toggleExpand2}
        shouldTruncate={shouldTruncate2}
        truncatedContent={truncatedContent2}
        alignment="right"
      />
      ...
      <TestimonialCard
        name="Jim Pantaleo"
        message={sentence3}
        imageSrc="/Testimonial/jim.jpeg"
        company="AI Institute"
        role="Business Development Coordinator"
        isExpanded={isExpanded3}
        toggleExpand={toggleExpand3}
        shouldTruncate={shouldTruncate3}
        truncatedContent={truncatedContent3}
        alignment="left"
      />
      ...
      <TestimonialCard
        name="Gopi"
        message={sentence4}
        imageSrc="/Testimonial/gopi.jpeg"
        company="Empower"
        role="IT Director"
        isExpanded={isExpanded4}
        toggleExpand={toggleExpand4}
        shouldTruncate={shouldTruncate4}
        truncatedContent={truncatedContent4}
        alignment="right"
      />
