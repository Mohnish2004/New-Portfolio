  ...
  return (
    <>
      ...
      <TooltipProvider delayDuration={0}>
        <div className="pointer-events-none inset-x-0 top-0 z-50 mx-auto flex h-20 ">
          <Dock className="pointer-events-auto bg-background/90 backdrop-blur-lg  relative mx-auto flex h-14 items-center px-1 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_20px_80px_-20px_#ffffff1f_inset]">
