...
<button  className='rounded-full shadow-sm dark:backdrop-blur-xl dark:bg-neutral-300/20 backdrop-blur-xl bg-neutral-300/20 p-1 animate-bounce' onClick={toggleChat}>
